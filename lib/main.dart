  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        // Add any other theme configurations you need
      ),
      home: MyHomePage(),
    );
  }
...
class MyHomePage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    if (_controller.screenArgument != null) {
      _controller.txtNameController.text =
      _controller.screenArgument!.listPayload![1];
      _controller.txtEmailController.text =
      _controller.screenArgument!.listPayload![0];
    }
    return Scaffold(
      appBar: AppBar(
        title: const Text(''),
      ...
      body: Center(
        child: UploadImageWidget(
          ...
          controllerGallery: _controller.uploadIDNo,
          controllerCamera: _controller.uploadIDNo,
...
//     int result = calculator.addOne(5);
//
//     print("__cal");
...
//                 AlertUtil.showResponseDialog(
//                     context: context, status: DialogStatus.error, content: "AlertUtil");
//               },
//               child: Text('Press Me'),
//             )
//           ],
